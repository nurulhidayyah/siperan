                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Tahap Pengembangan</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-md-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Pengapuran</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Tahap Pengembangan</div>
                        </div>
                        <div class="col-auto">
