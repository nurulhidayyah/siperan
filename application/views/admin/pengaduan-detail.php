...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-3 text-gray-800">Selamat Datang <?= $user['name']; ?></h1>
    <a href="<?= base_url('admin/pengaduan') ?>" class="btn btn-dark"><i class="fas fa-arrow-left"></i></a>
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="status" id="status-setuju" value="1">
